...
if (room = lTransition3)
{
	...
	endtext[5] = "The defining feature of this reactor is the taurus shape of the chamber that contain\n the hot plasma created by the fusion reaction...";
	endtext[6] = "This taurus shape protexcts us from encountering plasma \n that's ten times hotter than the center of the sun";
